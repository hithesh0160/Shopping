...
public class InstamartUtil extends BaseClass {
    ...
    public static void setKodathiLocationAddress() throws InterruptedException {
    ...
    public static void testSearchProduct(String name) throws Exception {
    ...
    public static void sortElementsByDiscount() {
